    ...
    <section id="agents" className="section-pad agents-section">
      <div className="container">
        <SectionHeader
          ...
          description="Each agent is presented with visual proof, architecture logic, tool stack, and a workflow JSON preview so visitors can understand the execution clearly."
        />

      ...
      <div className="container hero-grid">
        <motion.div variants={fadeUp} initial="hidden" animate="visible">
          ...
          <div className="hero-actions">
            <a className="btn btn-primary" href="#projects"><Rocket size={18} /> Explore my work</a>
            <a className="btn btn-secondary" href={`mailto:${profile.email}`}><Mail size={18} /> Contact me</a>
  ...
  return (
    <section id="experience" className="section-pad">
      <div className="container">
        <SectionHeader
          eyebrow="Experience"
          title="AI research internship with real automation execution."
          description="Building practical AI workflows that connect models, APIs, triggers, business tools, and real-world automation use cases."
        />
    ...
    <section id="projects" className="section-pad alt-section">
      <div className="container">
        <SectionHeader
          ...
          title="CrisisTwin AI — an AI disaster-response digital twin."
          description="A hosted full-stack project combining maps, weather intelligence, image understanding, routing, saved missions, authentication, and PDF reporting."
        />
...
function Agents({ openPreview }) {
  return (
    <section id="agents" className="section-pad agents-section">
      <div className="container">
        <SectionHeader
          eyebrow="AI automation lab"
          title="Nine working n8n agents across chat, RAG, voice, email, meetings, and CRM."
          description="Each workflow is presented with visual proof, architecture logic, tool stack, and a workflow blueprint so visitors can understand both the idea and execution."
        />
            ...
            return (
              <motion.article className="agent-card" key={agent.id} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <div className="agent-proof-row">
                  ...
                  <LinkButton href={agent.workflowFile} variant="secondary" icon={Workflow}>Workflow JSON</LinkButton>
                </div>
              </motion.article>
            );
          })}
...
function OlderProjects() {
  return (
    <section className="section-pad alt-section">
      <div className="container">
        <SectionHeader
          eyebrow="Earlier full-stack projects"
          title="Deployed systems that show full-stack fundamentals."
          description="These earlier projects show applied web engineering across civic tech, agriculture, operations, and education platforms."
        />

...
export const n8nAgents = [
  {
    ...
    visibility: 'Visual workflow proof and workflow blueprint available.',
    purpose:
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-01/workflows/telegram-ai-bot-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-01/workflows/telegram-ai-bot-agent.json',
  ...
  },
  {
    ...
    tools: ['n8n', 'Qdrant Vector Store', 'OpenAI Embeddings', 'OpenAI Chat Model', 'LangChain AI Agent', 'Document Loader'],
    workflow: [
      'Document ingestion reads and extracts text files',
      'OpenAI embeddings convert documentation into searchable vectors',
    ...
    workflowFiles: [
      { label: 'Ingestion JSON', href: 'assets/n8n-agents/agent-02/workflows/rag-document-ingestion.json' },
      { label: 'Retrieval JSON', href: 'assets/n8n-agents/agent-02/workflows/rag-retrieval-assistant.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-02/workflows/rag-document-ingestion.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-03/workflows/ai-auto-call-reminder-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-03/workflows/ai-auto-call-reminder-agent.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-04/workflows/daily-ai-briefing-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-04/workflows/daily-ai-briefing-agent.json',
  ...
  },
  {
    ...
    tools: ['n8n', 'OpenAI Chat Model', 'Qdrant Vector Store', 'OpenAI Embeddings', 'Google Sheets', 'Gmail', 'Form Trigger'],
    workflow: [
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-05/workflows/smartdesk-ai-assistant.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-05/workflows/smartdesk-ai-assistant.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-06/workflows/google-meet-setter-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-06/workflows/google-meet-setter-agent.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-07/workflows/ai-appointment-setter-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-07/workflows/ai-appointment-setter-agent.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-08/workflows/ai-email-assistant-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-08/workflows/ai-email-assistant-agent.json',
  ...
  },
  {
    ...
    workflowFiles: [
      { label: 'Workflow JSON', href: 'assets/n8n-agents/agent-09/workflows/meeting-intelligence-agent.json' }
    ],
    workflowFile: 'assets/n8n-agents/agent-09/workflows/meeting-intelligence-agent.json',
